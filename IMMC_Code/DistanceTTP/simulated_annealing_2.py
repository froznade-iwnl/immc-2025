...
file = "groupC.txt" # enter distance matrix file
bstFeasible = 99999999999
...
def findCanonicalPattern(numberOfTeams, numberOfRounds):
    ...
    # Creates 3-dimensional array of zeros.
    E = np.zeros((x, y, z))
...
def simulated_annealing(maxP, maxC, maxR, T, beta, weight, teta):
    ...
    while reheat <= maxR:
        ...
        print("Reheating")
        if bestFeasibleSolution is not bestFeasible:
